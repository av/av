 ...
 *
 * Usage: node scripts/record-graph-story.mjs [/blog/agentic-setup/index.html] [docs/graph-story-tooling] [story index on page]
 *
...
const OUT = join(ROOT, process.argv[3] ?? 'docs/graph-story-tooling');
